...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  project: {
    ...
    scanSubProjects: (repoPath) => electron.ipcRenderer.invoke("project:scanSubProjects", repoPath),
    detectRepoRoot: (localPath) => electron.ipcRenderer.invoke("project:detectRepoRoot", localPath)
  },
  // 分组相关
  group: {
  ...
  deploy: {
    ...
    batch: (config) => electron.ipcRenderer.invoke("deploy:batch", config),
  ...
  config: {
    ...
    selectSingleFile: () => electron.ipcRenderer.invoke("config:selectSingleFile"),
